...
public class NetworksSlimefunItemStacks {
    ...
    static {
        ...
        RADIOACTIVE_OPTIC_STAR = Theme.themedSlimefunItemStack(
            ...
            getPreEnchantedItemStack(Material.NETHER_STAR, true, new Pair<>(Enchantment.POWER, 1)), // old Enchantment.ARROW_DAMAGE
            Theme.CRAFTING,
        ...
        SHRINKING_BASE = Theme.themedSlimefunItemStack(
            "NTW_SHRINKING_BASE",
            getPreEnchantedItemStack(Material.PISTON, true, new Pair<>(Enchantment.POWER, 1)),   // old Enchantment.ARROW_DAMAGE
            Theme.CRAFTING,
            "Shrinking Base",
        ...
        ADVANCED_NANOBOTS = Theme.themedSlimefunItemStack(
            ...
            getPreEnchantedItemStack(Material.MELON_SEEDS, true, new Pair<>(Enchantment.POWER, 1)),  // old Enchantment.ARROW_DAMAGE
            Theme.CRAFTING,
            "Advanced Nanobots",
            "Teeny Tiny little bots that can",
            "help you with precise tasks.",
        ...
        PRISTINE_AI_CORE = Theme.themedSlimefunItemStack(
            ...
            getPreEnchantedItemStack(Material.TUBE_CORAL_BLOCK, true, new Pair<>(Enchantment.POWER, 1)), // old Enchantment.ARROW_DAMAGE
            Theme.CRAFTING,
            "Pristine A.I. Core",
        ...
        INTERDIMENSIONAL_PRESENCE = Theme.themedSlimefunItemStack(
            ...
            getPreEnchantedItemStack(Material.ARMOR_STAND, true, new Pair<>(Enchantment.POWER, 1)),  // old Enchantment.ARROW_DAMAGE
            Theme.CRAFTING,
        ...
        NETWORK_REMOTE_ULTIMATE = Theme.themedSlimefunItemStack(
            "NTW_REMOTE_ULTIMATE",
            getPreEnchantedItemStack(Material.GLOW_ITEM_FRAME, true, new Pair<>(Enchantment.POWER, 1)),  // old Enchantment.ARROW_DAMAGE
            Theme.TOOL,
        ...
        NETWORK_RAKE_3 = Theme.themedSlimefunItemStack(
            "NTW_RAKE_3",
            getPreEnchantedItemStack(Material.WEEPING_VINES, true, new Pair<>(Enchantment.UNBREAKING, 1)),    // old Enchantment.LUCK
            Theme.TOOL,
            "Network Rake (3)",
            "Right click a Network Object to",
            "break it instantly.",
        ...
        NETWORK_DEBUG_STICK = Theme.themedSlimefunItemStack(
            "NTW_DEBUG_STICK",
            getPreEnchantedItemStack(Material.STICK, true, new Pair<>(Enchantment.UNBREAKING, 1)),    // old Enchantment.LUCK
            Theme.TOOL,
            "Network Debug Stick",
            "Right click a Network Object to",
            "turn on debugging."
